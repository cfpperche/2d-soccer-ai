...
- **Portuguese in-game text** (`GOOOL`, `LANÇAMENTO`, `CHUTOU`, `RUBRO`,
  `AZUL`, `PAUSADO`) is deliberate flavor. Don't translate without being
  asked. README, code comments, and commit messages stay in English.
